            ...
            <div className="relative z-10">
              ...
              <div className="space-y-10 text-gray-200 text-xl md:text-3xl leading-relaxed font-extralight">
                ...
                <p className="text-gray-400 text-lg md:text-xl leading-loose">
                  قررت أن أمزج "سحابة" (نَسبي) مع "306" (تحدّيَّ الأكبر). حولت الألم إلى أمل، والخوف إلى فخامة. كل نفحة من عطورنا هي تحية للصمود، وتذكير بأن أجمل السحب هي التي تأتي بعد العاصفة.
                </p>
              </div>
            </div>
          </motion.div>
