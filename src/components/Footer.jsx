...
const Footer = () => {
  const [whatsappPhone, setWhatsappPhone] = useState("212693312011"); // Valeur par défaut
  ...
  useEffect(() => {
    ...
    return () => unsub(); // Nettoyage de l'écouteur
  }, []);
  ...
  return (
    <footer className="bg-black text-white py-12 mt-20">
      ...
      <div className="border-t border-gray-800 mt-10 pt-6 text-center text-[10px] text-gray-500 uppercase tracking-widest">
        &copy; 2026 Sahaba Parfum 306. Powered by Hipatya Dev.
      </div>
    </footer>
  );
};
